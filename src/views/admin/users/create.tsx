            ...
            <div className="card-body">
              <form onSubmit={storeUser}>
                ...
                <div className="form-group mb-3">
                  ...
                  {errors.Email && (
                    <div
                      className="alert alert-danger mt-2 rounded-
4"
                    >
                      {errors.Email}
                    </div>
...
4"
                ...
                <button
                  type="submit"
                  className="btn btn-primary rounded-4 shadow-sm border-0"
                >
                ...
                <Link
                  to="/admin/users"
                  className="btn btn-secondary rounded-4 shadow-sm border-0"
                >
                  Cancel
                </Link>
              </form>
